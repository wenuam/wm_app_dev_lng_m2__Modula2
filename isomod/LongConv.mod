...
PROCEDURE doFormat(str : ARRAY OF CHAR; VAR real : LONGREAL) : ConvResults;
VAR
    gotOne      : BOOLEAN;
        ...
        LOOP
            ...
            ConvTypes.valid:
                ...
                ELSE
                    ...
                    whole:
                        gotOne := TRUE;
                        IF real < 1.79E307 THEN
                            real := (real * 10.0) +
                                        LFLOAT(ORD(str[i]) - ORD('0'));
                        ELSE
                            RETURN strOutOfRange;
                        END;
                    |
                    fraction:
                        frac := LFLOAT(ORD(str[i]) - ORD('0')) / fracPlace;
...
*)
BEGIN
    RETURN IsCurrentSource(LongConvSrc);
